...
export default function LandingPage() {
  ...
  const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://medicine-demand-forecast-and-stock-out-9qje.onrender.com/docs';
      ...
      <main className="flex-1 relative z-10 w-full max-w-4xl mx-auto px-6 py-24 text-center flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-16">
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-slate-800 bg-white/95 backdrop-blur-md border border-slate-200 rounded-xl hover:border-emerald-600 hover:text-emerald-700 transition-all shadow-sm"
          >
